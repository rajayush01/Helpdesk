import { ChevronRight, LayoutDashboard, Tickets, TicketPlus, Tangent } from 'lucide-react'
import React from 'react'

const OperartionTeamSidebar = ({ activeSection, setActiveSection }) => {
  const items = [
    { label: "Dashboard", icon: LayoutDashboard },
    { label: "Ticket Approval", icon: TicketPlus },
...
export default OperartionTeamSidebar
